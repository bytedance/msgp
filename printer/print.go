...
func generate(f *parse.FileSet, mode gen.Method) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports := []string{"github.com/henrylee2cn/msgp/msgp"}
	...
	if mode&gen.Test == gen.Test {
		...
		if mode&(gen.Encode|gen.Decode) != 0 {
			writeImportHeader(testbuf, "bytes", "github.com/henrylee2cn/msgp/msgp", "testing")
		} else {
			writeImportHeader(testbuf, "github.com/henrylee2cn/msgp/msgp", "testing")
		}
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	...
	b.WriteString("// Code generated by github.com/henrylee2cn/msgp DO NOT EDIT.\n\n")
}
...
// var msgpGopkg = func() string {
// 	_, file, _, _ := runtime.Caller(1)
// 	p := strings.Replace(file, string(os.PathSeparator), "/", -1)
// 	p = p[strings.Index(p, "/src/")+len("/src/"):]
// 	p = p[:strings.LastIndex(p, "/")]
// 	p = p[:strings.LastIndex(p, "/")]
// 	p += "/msgp"
// 	fmt.Printf(chalk.Magenta.Color("======== Using %q =======")+"\n", p)
// 	return p
// }()
