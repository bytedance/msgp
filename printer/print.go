...
func generate(f *parse.FileSet, mode gen.Method) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports := []string{"github.com/bytedance/msgp/msgp"}
	...
	if mode&gen.Test == gen.Test {
		...
		if mode&(gen.Encode|gen.Decode) != 0 {
			writeImportHeader(testbuf, "bytes", "github.com/bytedance/msgp/msgp", "testing")
		} else {
			writeImportHeader(testbuf, "github.com/bytedance/msgp/msgp", "testing")
		}
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	...
	b.WriteString("// Code generated by github.com/bytedance/msgp DO NOT EDIT.\n\n")
}
